      ...
      <div class="container-fluid">
        ...
        <nav class="menu-desktop">
          <ul>
            ...
            <li><a class="github-button" href="https://github.com/eclipse/che" data-icon="octicon-star" data-show-count="true" aria-label="Star eclipse/che on GitHub" width="100px" height="20px">Star</a></li>
