...
<div class="annoucement">
  <div class="container-fluid">
    <p>Read the Eclipse Che <a href="http://che.eclipse.org/release-notes-eclipse-che-4-3" target="_blank">4.3 Release Notes</a></p>
  </div>
</div>
...
<div class="container-fluid content whats-new">
  ...
  <div class="row">
    <div class="col-md-4">
      <img src="images/img-home-whatsnew1@2x.png" alt="" class="img-responsive">
      <h3>Not just another IDE</h3>
      <p>Eclipse Che is  an IDE and developer workspace server that allows anyone to contribute to any project. </p>
      <a href="<?php echo $rootPath; ?>/technology/" class="btn-yellow">How Eclipse Che Works</a>
    </div>
    <div class="col-md-4">
...
<div class="bg-deep-purple feedback">
  <div class="container-fluid content">
    ...
    <ul>
      ...
      <li><span><i class="fa fa-twitter"></i> @mogreau</span> Contribute to an open source project in less than 10 minute with @eclipse_che!</li>
