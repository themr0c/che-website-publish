...
<div class="container-fluid content options">
  ...
  <div class="row">
    ...
    <div class="col-sm-6">
      ...
      <h2>Codenvy</h2>
      <p>As the original donors of Eclipse Che, Codenvy continues to support the project while building  on top of Che a set of enterprise-focused features demanded are by IT: multi-tenancy; elastic scalability; LDAP integration; security and resource controls.</p>
